class shylnk{
    constructor(){
        this.api = "https://api.shylnk.com/api"
    ...
    async short_url(url){
        let req=await fetch(`${this.api}/url_shortener`,{method:"POST",body:JSON.stringify({"url":url}),headers: this.headers});
        return await req.json();
    }
}
module.exports = {shylnk};